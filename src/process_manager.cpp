...
int ProcessManager::executeExternal(
    ...
    const std::map<std::string, std::string>& environment, std::istream& input,
    ...
    BOOL success = CreateProcessA(
        NULL, const_cast<char*>(cmdLine.c_str()), NULL, NULL, TRUE, 0,
        envBlock.empty() ? NULL : const_cast<char*>(envBlock.c_str()), NULL,
        &si, &pi);
